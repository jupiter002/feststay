...
ax.set_ylabel('축제 지역별 예산합계', fontsize=15)

ax.set_title('2022년 전국 축제 예산합계', fontsize=30, pad=30)
...
ax.set_title('2022년 전국 축제 방문객수합계 (단위:100명)', fontsize=30, pad=30)
ax.legend(loc='upper left', fontsize=15)
ax.grid(visible=False)
...
ax.set_ylabel('축제 개최 수', fontsize=15)
ax.set_title('2023년 전라남도 월별 축제 종류', fontsize=30, pad=30)
ax.legend(loc='upper left', fontsize=15)
ax.grid(visible=False)
